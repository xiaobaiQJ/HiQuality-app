<template>
  <div class="text-center main-jl">
    ...
    <p>黔西南州兴义环城高速公路</p>
    <h3>专项安全施工方案汇总表</h3>
    <table cellspacing="0" cellpadding="0" class="public-tabel" width="645">
      <tr>
        <td>序号</td>
        <td width="150">专项施工方案名称  </td>
        <td>报送日期   </td>
        <td>审查日期</td>
        <td> 实施日期</td>
        <td> 完整与否</td>
...
<script>
    export default {
      ...
      methods: {
        ...
        //查询
        getData() {
          this.axios.get('/HiQuality/JL14/findJL14ById', {
            params: {
        ...
        addData() {
          ...
          this.axios.post("/HiQuality/JL14/saveJL14", this.$qs.stringify({
            jl14:JSON.stringify(this.obj),
        ...
        //修改
        updateData() {
          this.axios.post('/HiQuality/JL14/updateJL14', this.$qs.stringify({
            jl14:JSON.stringify(this.obj),
          }))
            .then(res => {
              console.log("修改接口")
        ...
        //删除
        deleteData() {
          this.axios.get('/HiQuality/JL14/deleteJL14', {
            params: {
               id: this.id,
              pageNo:this.pageNo
            }
