    ...
    <div class="text-center main-jl">
      ...
      <table cellspacing="0" cellpadding="0" class="public-tabel">
        ...
        <tr v-for="(val,index) in controlArr" :key="index">
          <td width="45"><input type="text" v-model="val.s1"></td>
          <td width="54"><input type="text" v-model="val.s2"></td>
          <td width="40"><input type="text" v-model="val.s3"></td>
          <td width="72"><input type="text" v-model="val.s4"></td>
          <td width="63"><input type="text" v-model="val.s5"></td>
          <td width="60"><input type="text" v-model="val.s6"></td>
          ...
          <td width="61"><input type="text" v-model="val.s10"></td>
          <td width="86"><input type="text" v-model="val.s11"></td>
        </tr>
      </table>
      <div class="btn">
...
<script>
    export default {
      ...
      methods: {
        ...
        //查询
        getData() {
          this.axios.get('/HiQuality/JL04/findJL04ById', {
            params: {
        ...
        addData() {
          ...
          this.axios.post("/HiQuality/JL04/saveJL04", this.$qs.stringify({
            jl04:JSON.stringify(this.obj),
        ...
        //修改
        updateData() {
          this.axios.post('/HiQuality/JL04/updateJL04', this.$qs.stringify({
            jl04:JSON.stringify(this.obj),
          }))
            .then(res => {
              console.log("修改接口")
        ...
        //删除
        deleteData() {
          this.axios.get('/HiQuality/JL04/deleteJL04', {
            params: {
              id: this.id,
              pageNo:this.pageNo
            }
