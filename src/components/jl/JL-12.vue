<template>
    <div class="text-center main-jl">
      ...
      <p>黔西南州兴义环城高速公路</p>
      <h3>监理工程师指令单及回复记录台账</h3>
      <table cellspacing="0" cellpadding="0" class="public-tabel" width="648">
        <tr>
          <td>序号</td>
          <td width="101">监理工程师<br />
            通知（指令）</td>
          <td>签发日期 </td>
          <td> 签发人</td>
          <td width="72">施工单位<br />
            回复单日期</td>
          <td width="72">检查签收人 </td>
          <td width="115">质量整改情况</td>
          <td> 备注</td>
        </tr>
...
<script>
    export default {
      ...
      methods: {
        ...
        //查询
        getData() {
          this.axios.get('/HiQuality/JL12/findJL12ById', {
            params: {
        ...
        addData() {
          ...
          this.axios.post("/HiQuality/JL12/saveJL12", this.$qs.stringify({
            jl12:JSON.stringify(this.obj),
        ...
        //修改
        updateData() {
          this.axios.post('/HiQuality/JL12/updateJL12', this.$qs.stringify({
            jl12:JSON.stringify(this.obj),
          }))
            .then(res => {
              console.log("修改接口")
        ...
        //删除
        deleteData() {
          this.axios.get('/HiQuality/JL12/deleteJL12', {
            params: {
               id: this.id,
              pageNo:this.pageNo
            }
