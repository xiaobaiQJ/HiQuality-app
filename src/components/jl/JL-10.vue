<template>
    <div class="text-center main-jl">
      ...
      <p>黔西南州兴义环城高速公路</p>
      <h3>计量支付台账</h3>
      <table cellspacing="0" cellpadding="0" class="public-tabel" width="1008">
        <tr>
          <td rowspan="2" width="72">清单<br />
            编号</td>
          <td rowspan="2" width="72">项目<br />
            名称</td>
          <td rowspan="2" width="72">单位</td>
          <td rowspan="2" width="72">合同<br />
            数量</td>
          <td colspan="2" width="144">第一期 </td>
          <td colspan="2" width="144">第二期 </td>
          <td colspan="2" width="144">第三期 </td>
...
<script>
    export default {
      ...
      methods: {
        ...
        //查询
        getData() {
          this.axios.get('/HiQuality/JL10/findJL10ById', {
            params: {
        ...
        addData() {
          ...
          this.axios.post("/HiQuality/JL10/saveJL10", this.$qs.stringify({
            jl10:JSON.stringify(this.obj),
        ...
        //修改
        updateData() {
          this.axios.post('/HiQuality/JL10/updateJL10', this.$qs.stringify({
            jl10:JSON.stringify(this.obj),
          }))
            .then(res => {
              console.log("修改接口")
        ...
        //删除
        deleteData() {
          this.axios.get('/HiQuality/JL10/deleteJL10', {
            params: {
               id: this.id,
              pageNo:this.pageNo
            }
