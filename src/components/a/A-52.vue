<template>
    <div class="A52 text-center main-a crosswise-a crosswise">
      <p class="top-name-p width-1086">A-52</p>
      ...
      <div align="center">
        <table width="1084" border="0" cellspacing="0" class="public-tabel table-tr-height-20">
          <tr>
      ...
      <p class="bot-hint-p width-1086">注：填写时以&#8220;&#9633;&#8221;代表缺岗，&#8220;&#9651;&#8221;代表脱岗，&#8220;&#9675;&#8221;代表病假， &#8220;&#8251;&#8221;代表事假，&#8220;&#9678;&#8221;代表轮休，&#8220;&#9632;&#8221;代表出勤。本表人员同一览表。 </p>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      //查询
      getData() {
        this.axios.get('/HiQuality/A52/findA52ById', {
          params: {
      ...
      addData() {
        ...
        this.axios.post("/HiQuality/A52/saveA52", this.$qs.stringify({
          a52:JSON.stringify(this.v),
      ...
      updateData() {
        this.obj.subList = this.controlArr;
        this.axios.post('/HiQuality/A52/updateA52', this.$qs.stringify({
          a52:JSON.stringify(this.obj)
        }))
          .then(res => {
            console.log("修改接口")
            console.log(res)
      ...
      //删除
      deleteData() {
        this.axios.get('/HiQuality/A52/deleteA52', {
          params: {
            id: this.id
          }
        }).then(res => {
