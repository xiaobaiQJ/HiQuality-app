<template>
    <div class="A63 text-center main-a lengthways-a">
      <p class="top-name-p width-663">A-63</p>
      <p align="center" >贵 州 省 高 速 公 路 建 设 项 目 </p>
      <p>黔西南州兴义环城高速公路</p>
      <h3>承包人现场劳动力申报汇总表</h3>
      <p class="title-p-right margin-auto width-663">责查表-19</p>
      ...
      <p class="bot-hint-p width-663">注：汇总A-61表，编入工程月报，每月申报。 <br />
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      //查询
      getData() {
        this.axios.get('/HiQuality/A63/findA63ById', {
          params: {
      ...
      addData() {
        ...
        this.axios.post("/HiQuality/A63/saveA63", this.$qs.stringify({
          a63:JSON.stringify(this.obj),
      ...
      updateData() {
        this.obj.subList = this.controlArr;
        this.axios.post('/HiQuality/A63/updateA63', this.$qs.stringify({
          a63:JSON.stringify(this.obj)
        }))
          .then(res => {
            console.log("修改接口")
      ...
      //删除
      deleteData() {
        this.axios.get('/HiQuality/A63/deleteA63', {
          params: {
            id: this.id
          }
        }).then(res => {
