<template>
    <div class="A69 text-center main-a lengthways-a table-padding5px">
      <p class="top-name-p width-598">A-69</p>
      ...
      <div align="center">
        <table border="1" cellspacing="0" >
          <tr >
            <td width="604" valign="top" colspan="2" ><p >&nbsp;</p>
              <p >致（驻地办驻地监理工程师）<input type="text" class="title-input" v-model="obj.m1">： </p><br />
              <p style="text-indent: 30px;">根据合同要求，我项目部已做好相关导线、水准测量复测控制工作，现将复测成果上报，请予批准。 <br /><br />
                附件： </p>
              <p ></p><br/><br/><br/><br/><br/><br/><br/>
              <div align="right">项目经理：<input type="text" class="input-80" v-model="obj.m2">
          ...
          <tr >
            <td width="604" valign="top" colspan="2" >
              <p >驻地办驻地监理工程师意见：
                <textarea name="" cols="30" rows="10" v-model="nameList2[0].auditOpinion" disabled></textarea>
              </p>
              <p align="right">
          ...
          <tr >
            <td width="346" valign="top" ><p >总监办意见： </p>
              <textarea name="" cols="30" rows="8" v-model="nameList3[0].auditOpinion" disabled></textarea>
              <p align="right">
            ...
            <td width="258" valign="top" ><p >项目公司意见： </p>
              <textarea name="" cols="30" rows="8" v-model="nameList4[0].auditOpinion" disabled></textarea>
              <p align="right">
                签字：<input type="text" class="height-25 " v-model="nameList4[1].fullName" disabled>
...
<script>
  ...
  export default {
    ...
    methods: {
      getData() {
        this.axios.get('/HiQuality/A69/findA69ById', {
          params: {
      ...
      addData() {
        ...
        this.axios.post("/HiQuality/A69/saveA69", this.$qs.stringify({
          a69:JSON.stringify(this.obj),
      ...
      //修改
      updateData() {
        this.axios.post('/HiQuality/A69/updateA69',this.$qs.stringify({
          a69:JSON.stringify(this.obj)
        }))
          .then(res => {
            console.log("修改接口")
      ...
      //删除
      deleteData() {
        this.axios.get('/HiQuality/A69/deleteA69', {
          params: {
            id: this.id
          }
        }).then(res => {
