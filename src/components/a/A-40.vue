<template>
    <div class="A40 text-center main-a lengthways-a table-padding5px">
      ...
      <div class="text-left">
        ...
        <span>合 同 号：<input type="text" v-model="obj.m19" disabled></span>
        <div class="myClear"></div>
      </div>
      <div class="text-left">
        <span>监理单位：<input type="text" v-model="obj.m20" disabled></span>
  ...
  export default {
    ...
    watch: {
      ...
      getTableInfoList: function () {
        ...
        //获取监理单位信息赋值给主表对象
        this.obj.m20 = this.supervisorTableInfo.unitName2;
      },
      //获取rec信息数据
      getRecObj: function () {
