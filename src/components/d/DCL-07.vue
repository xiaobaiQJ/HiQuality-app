<template>
    <div class="DCL-07 text-center">
      <p class="top-name-p width-968">DCL-07</p>
      <p>  贵 州 省 高 速 公 路 建 设 项 目 </p>
      <h3>黔 西 南 州 兴 义 环 城 高 速 公 路</h3>
      <h3><strong>水准点测量对照表</strong></h3>
      <div class="public-tilte flex-r margin-auto width-991">
        ...
        <div>
          <p>合同号： <input type="text" v-model="headerInfo.contractCode" disabled></p>
          <p>测量范围或桩号：<input type="text" v-model="obj.m1"></p>
        </div>
        <div>
      ...
      <div align="center">
        <table border="1" cellspacing="0" class="public-tabel" >
          <tr >
            <td width="282" valign="center" colspan="3" ><br />
              施工水准点BM&#8217; </td>
            ...
            <td width="94" valign="center" rowspan="2" ><p align="center" >&#9651;容(mm) </p></td>
            <td width="94" valign="center" rowspan="2" ><p align="center" >&#9651;测(mm) </p></td>
          ...
          <tr >
            ...
            <td width="95" valign="center" ><p align="center" >高程（m） </p></td>
            <td width="93" valign="center" ><p align="center" >编号 </p></td>
            <td width="93" valign="center" ><p align="center" >位置 </p></td>
            <td width="94" valign="center" ><p align="center" >高程(m) </p></td>
          </tr>
          <tr v-for="(val,index) in controlArr" :key="index">
            ...
            <td width="95" valign="center" ><input type="text" v-model="val.s3"></td>
            <td width="93" valign="center" ><input type="text" v-model="val.s4"></td>
            <td width="93" valign="center" ><input type="text" v-model="val.s5"></td>
            <td width="94" valign="center" ><input type="text" v-model="val.s6"></td>
            <td width="95" valign="center" ><input type="text" v-model="val.s7"></td>
            <td width="94" valign="center" ><input type="text" v-model="val.s8"></td>
            <td width="94" valign="center" ><input type="text" v-model="val.s9"></td>
            <td width="95" valign="top" rowspan="11" v-if="index===0">
              <ol>
      ...
      <p class="bot-hint-p width-991">测量：<input type="text" v-model="obj.m2" class="input-105">计算：<input type="text" v-model="obj.m3" class="input-105">复核：<input type="text" v-model="obj.m4" class="input-105">监理：<input type="text" v-model="nameList1[1].fullName" disabled class="input-105">  
  ...
  import {splitDate, joinDate} from '../../utils/utils'
    export default {
      ...
      methods:{
        ...
        //查询
        getData(){
          this.axios.get('/HiQuality/dcl7/findById',{
            params:{
        ...
        addData(){
          ...
          this.axios.post('/HiQuality/dcl7/save',this.$qs.stringify({
            BBtDcl7M:JSON.stringify(this.obj),
        ...
        updateData(){
          this.obj.subList = this.controlArr;
          this.axios.post('/HiQuality/dcl7/update',this.$qs.stringify({
            BBtDcl7M:JSON.stringify(this.obj)
          })).then(res=>{
            console.log("修改接口")
            console.log(res);
        ...
        //删除
        deleteData(){
          this.axios.get('/HiQuality/dcl7/deleteById',{
            params:{
              id:this.id
            }
          }).then(res=>{
