<template>
    <div class="text-center main-d lengthways-a">
      <p class="top-name-p width-663">DCL-16</p>
  ...
  import {splitDate, joinDate} from '../../utils/utils'
    export default {
      ...
      methods: {
        ...
        //查询
        getData() {
          this.axios.get('/HiQuality/dcl16/findById', {
            params: {
        ...
        addData() {
          ...
          this.axios.post('/HiQuality/dcl16/save',this.$qs.stringify({
            BBtDcl16M:JSON.stringify(this.obj),
        ...
        updateData() {
          this.obj.subList = this.controlArr;
          this.axios.post('/HiQuality/dcl16/update',this.$qs.stringify({
            BBtDcl16M:JSON.stringify(this.obj)
          })).then(res=>{
            console.log("修改接口")
            console.log(res);
        ...
        //删除
        deleteData() {
          this.axios.get('/HiQuality/dcl16/deleteById', {
            params: {
              id: this.id
            }
          }).then(res => {
