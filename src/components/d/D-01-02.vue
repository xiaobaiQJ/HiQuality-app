<template>
  <div class="D-01-02 text-center">
    <p class="top-name-p width-618">D-01-02</p>
  <p align="center" >贵 州 省 高 速 公 路 建 设 项 目 </p>
  <h3 align="center"><strong>黔西南州兴义环城高速公路</strong><strong> </strong></h3>
  <h3 align="center"><strong>清理与掘除及堆放现场检查记录</strong><strong> </strong></h3>
  ...
  <div align="center">
    <table border="1" cellspacing="0" class="public-tabel">
      ...
      <tr >
        ...
        <td width="473" valign="center" colspan="3" ><p align="center" >
      ...
      <tr >
        ...
        <td width="473" valign="center" colspan="3" ><p align="center" >
          <textarea name="" cols="50" rows="5" v-model="obj.m7"></textarea>
        </p></td>
      </tr>
      <tr >
    ...
    <p class="bot-hint-p width-618">施工单位技术负责人：<input type="text" v-model="obj.m10" class="input-50"> 记录：<input type="text" v-model="obj.m11" class="input-50"> 监理员：<input type="text" v-model="nameList1[1].fullName" disabled class="input-50">日期：<input type="text" class="date-input height-25" v-model="m15DataArr[0]" disabled>年<input type="text" class="date-input height-25" v-model="m15DataArr[1]" disabled>月<input type="text" class="date-input height-25" v-model="m15DataArr[2]" disabled>日
    </p>
    <div class="btn">
  ...
  import {splitDate} from '../../utils/utils'
    export default {
      ...
      methods:{
        //查询
        getData(){
          this.axios.get('/HiQuality/d1b/findById',{
            params:{
        ...
        //新增
        addData(){
          this.axios.post('/HiQuality/d1b/save',this.$qs.stringify({
            BBtD1BM:JSON.stringify(this.obj),
        ...
        //修改
        updateData(){
          this.axios.post('/HiQuality/d1b/update',this.$qs.stringify({
            BBtD1BM:JSON.stringify(this.obj)
          })).then(res=>{
            console.log("修改接口")
            console.log(res);
        ...
        //删除
        deleteData(){
          this.axios.get('/HiQuality/d1b/deleteById',{
            params:{
              id:this.id
            }
          }).then(res=>{
